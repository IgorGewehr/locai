// Teste direto do ProfessionalAgent
// Para testar: node test-agent-direct.js

// Mock das variáveis de ambiente
process.env.OPENAI_API_KEY = 'sk-test-fake';
process.env.TENANT_ID = 'test-tenant';

async function testAgentSingleton() {
  console.log('🧪 Testando ProfessionalAgent singleton...\n');
  
  try {
    console.log('⚠️  Testando a lógica do singleton com implementação de exemplo\n');
    
    // Implementação simplificada para testar o conceito
    class TestSingleton {
      constructor() {
