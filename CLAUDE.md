...
- **100% GPT-Powered**: Every response generated by OpenAI GPT-3.5 Turbo for maximum naturalness
...
### Key Files to Know
- **Sofia AI Agent**: `lib/ai-agent/sofia-agent-v2.ts` - Main conversational AI
...
5. **New API Route**: Add to `app/api/` following patterns
6. **UI Component**: Use atomic design in `components/`
7. **Database Model**: Extend types in `lib/types/`
