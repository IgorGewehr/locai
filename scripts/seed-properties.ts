...
const sampleProperties = [
  ...
  },
  {
    ...
    description: 'Luxuosa cobertura duplex com vista de 360° da cidade. Acabamento de alto padrão e todas as comodidades.',
    type: 'Cobertura',
    bedrooms: 4,
    bathrooms: 3,
    maxGuests: 10,
    area: 200,
    address: 'Av. Beira Mar Norte, 2000',
    city: 'Florianópolis',
    neighborhood: 'Centro',
    basePrice: 800,
    cleaningFee: 200,
    pricePerExtraGuest: 80,
    minimumNights: 5,
    amenities: ['Piscina Privativa', 'Sauna', 'Academia', 'Churrasqueira Gourmet', 'Home Theater', 'Varanda Gourmet', 'Wi-Fi', 'Ar Condicionado Central'],
    photos: [
      {
        url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=800',
        caption: 'Vista da sala principal',
        order: 0,
        isMain: true
      },
      {
      ...
      },
      {
        ...
        caption: 'Vista aérea da cobertura',
        order: 2,
        isMain: false
      }
    ],
...
async function seedProperties() {
  try {
    ...
    console.log('\n💡 Note: All properties were assigned to tenant ID: default-tenant');
    console.log('   You may need to update the tenant ID to match your actual user ID.');
