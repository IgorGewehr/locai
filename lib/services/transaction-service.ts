...
export const createTransactionService = createTransactionServiceV2;
export const TransactionService = TransactionServiceV2;

// DEPRECATED: Singleton export for backward compatibility
// TODO: Refactor financial-analytics-service.ts to use tenant-scoped service
// This is a placeholder that will cause runtime errors if tenant context is missing
export const transactionService = {
  async getByDateRange(startDate: Date, endDate: Date) {
    throw new Error('DEPRECATED: Use createTransactionService(tenantId) instead');
  },
  async getRecurring() {
    throw new Error('DEPRECATED: Use createTransactionService(tenantId) instead');
  }
