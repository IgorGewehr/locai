...
export class NotificationService {
  ...
  // ADMIN NOTIFICATIONS
  // NOTE: Admin notification methods have been moved to lib/utils/admin-notifications.ts
  // Use notifyAdminsNewUser(), notifyAdminsNewTicket(), notifyAdminsTicketUserResponse() instead
  // These functions properly route notifications to each admin's tenant with their real userId
